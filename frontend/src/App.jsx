...
export default function App() {
  ...
  return (
    <div className="app">
      {gameState==='start'&&<StartScreen onStart={handleStart} highScore={highScore}/>}
      {gameState==='playing'&&<Game onGameOver={handleGameOver} onWin={handleWin}/>}
      {gameState==='gameover'&&<GameOver score={score} highScore={highScore} onRestart={handleStart}/>}
      {gameState==='win'&&<WinScreen score={score} highScore={highScore} onRestart={handleStart}/>}
    </div>
  );
}
